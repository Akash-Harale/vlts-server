...
*/
router.post('/', authMiddleware(["create_driver"]), driverController.createDriver);       // Create

/*
GET /api/drivers
*/
router.get('/', authMiddleware(["read_driver"]), driverController.getAllDrivers);       // Read all

/*
GET /api/drivers/67a0f1c2e4b1a9d123456789
*/
router.get('/:id', authMiddleware(["read_driver"]), driverController.getDriverById);   // Read one
...
*/
router.put('/:id', authMiddleware(["update_driver"]), driverController.updateDriver);    // Update
